...
function tudoPreenchido() {
  ...
  if (form.elements.antecipacao.value == 0) tudoCertinho = false;
  if (form.elements.faturamento.value == 0) tudoCertinho = false;
  if (form.elements.conferenciaVendas.value == 0) tudoCertinho = false;
  if (form.elements.adquirintes.value == 0) tudoCertinho = false;
  if (form.elements.maquinas.value == 0) tudoCertinho = false;
  if (
    form.elements.cartaobeneficio0.checked == false &&
    form.elements.cartaobeneficio1.checked == false
  )
    tudoCertinho = false;
  if (
    form.elements.aluguelMaquinas0.checked == false &&
    form.elements.aluguelMaquinas1.checked == false
  )
    tudoCertinho = false;
...
function escreverPerda() {
  ...
  if (tudoPreenchido()) {
    ...
    document.getElementById("outputSimulador").innerHTML =
      "Confira resultados abaixo";
    //jumbotron
    document.getElementById("numeroDinheiro").innerHTML = "R$ " + perda + ",00";
    document.getElementById("dinheiroAno").innerHTML =
      "R$ " + perda * 12 + ",00";
    ...
    document.getElementById("outputSimulador").innerHTML =
      "Você não respondeu todos os campos necessários..";
}
